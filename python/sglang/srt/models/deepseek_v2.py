...
class DeepseekV2AttentionMLA(
    ...
    def __init__(
        ...
        self.use_min_latency_fused_a_gemm = (
            ...
            # A quantized fused_qkv_a (e.g. hybrid_int4_nvfp4) has no dense ``.weight``; the helper reads
            # ``.weight`` directly, so guard for presence first (short-circuits) before deferring to it.
