...
def _paged_experts_breakable_decode(server_args) -> bool:
    ...
    paging bottleneck anyway. (Mirrors the backend-resolution in paged_experts/method.py.)"""
...
class DeepseekV2MoE(nn.Module):
    ...
    def forward(
        ...
        if not self._enable_a2a_moe:
            ...
            if self._can_dual_stream_graph(hidden_states, server_args) and not _force_single_stream:
